...
export class RegisterComponent implements OnInit {
  ...
  registerForm = new FormGroup({
    ...
    contactNo : new FormControl('',[Validators.required ,Validators.maxLength(12)]),
  ...
  campusMindRole() {
      ...
      this.registerForm.addControl("engineeringBranch",new FormControl('',[Validators.required ,Validators.maxLength(50)]));
  ...
  mindtreeMindRole() {
    ...
    this.registerForm.addControl("location",new FormControl('',[Validators.required ,Validators.maxLength(50)]));
    this.registerForm.addControl("track",new FormControl('',[Validators.required ,Validators.maxLength(50)]));
